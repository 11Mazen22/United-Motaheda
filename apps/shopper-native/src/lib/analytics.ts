...
export type AnalyticsEvent =
  ...
  | "cart_opened"
  // Checkout funnel — every step emitted so conversion funnels are measurable
  | "checkout_started"
  | "checkout_step_details_viewed"
  | "checkout_step_review_viewed"
  | "checkout_address_entered"
  | "checkout_address_selected_saved"
  | "checkout_address_pin_confirmed"
  | "checkout_branch_selected"
  | "checkout_branch_changed"
  | "checkout_payment_selected"
  | "checkout_coupon_applied"
  | "checkout_coupon_failed"
  | "checkout_coupon_removed"
  | "checkout_delivery_quote_received"
  | "checkout_otp_requested"
  | "checkout_otp_verified"
  | "checkout_otp_cancelled"
  | "checkout_submitted"
  | "checkout_completed"
  | "checkout_failed"
