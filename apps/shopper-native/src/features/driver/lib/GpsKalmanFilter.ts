/**
 * GPS coordinate smoothing — ported nearly verbatim from courier-mobile's
 * src/lib/gps/KalmanFilter.ts (retired app, driver-app-consolidation plan).
 * Self-contained, zero external imports, business-logic-agnostic — a
