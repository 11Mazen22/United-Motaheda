...
export async function fetchProductsPage(args: FetchProductsArgs = {}): Promise<ProductPage> {
  ...
  // search_effective_products now does Arabic normalization, synonym
  // expansion, and trigram/word-similarity fuzzy matching server-side (see
  // supabase/migrations/20260826090000_product_intelligence_stage1_core.sql)
  // — no client-side retry-on-zero-results needed anymore.
