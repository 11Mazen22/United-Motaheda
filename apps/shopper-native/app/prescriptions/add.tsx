...
import { createWhatsAppPrescriptionPlaceholder } from "@/features/prescriptions/api";
        ...
        <View
          ...
          <View style={s.chevronWell}>
            <Ionicons
              ...
              size={16}
              color={option.comingSoon ? c.inkFaint : c.inkSoft}
            />
          </View>
        </View>
      )}
        ...
        <View style={s.infoCallout}>
          <View style={s.infoHead}>
            <View style={s.infoIconWell}>
              <Ionicons name="shield-checkmark-outline" size={18} color={c.warn} />
            </View>
