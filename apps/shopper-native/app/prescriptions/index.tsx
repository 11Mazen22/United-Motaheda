    ...
    <View style={[s.header, { paddingTop: insets.top + 12 }]}>
        ...
        <Pressable
          ...
          {({ pressed }) => (
            <View style={[s.addPill, pressed && s.addPillPressed]}>
              <Ionicons name="add" size={14} color={c.accentDeep} style={IS_RTL ? { marginStart: 6 } : { marginEnd: 6 }} />
      ...
      <View style={s.identityRow}>
        <View style={s.heroTile}>
          <Ionicons name="medkit" size={24} color={c.accentDeep} />
        </View>
        ...
        ListEmptyComponent={
          <View style={s.filterEmpty}>
            <View style={s.filterEmptyIcon}>
              <Ionicons name="funnel-outline" size={22} color={c.inkFaint} />
            </View>
