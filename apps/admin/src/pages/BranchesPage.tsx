...
export function BranchesPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-2xl font-bold text-pharmacy-ink dark:text-white">Branches</h1>
        <p className="text-sm text-pharmacy-inkSoft dark:text-gray-400 mt-1">Manage platform branches</p>
      </div>
