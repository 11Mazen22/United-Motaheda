...
export const locations = [
  {
    ...
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.0683587, 31.3880317),
    mapQuery: "30.0683587,31.3880317",
    lat: 30.0683587,
    lng: 31.3880317,
    mapZoom: 18,
    isPrimary: true,
    ...
    mapEmbedSrc: buildMapEmbedUrl(30.0683587, 31.3880317, 18),
  },
  {
    id: "maadi",
    nameAr: "المعادي",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(29.9776648, 31.2842375),
    mapQuery: "29.9776648,31.2842375",
    lat: 29.9776648,
    lng: 31.2842375,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "المعادي",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(29.9776648, 31.2842375, 18),
  },
  {
    id: "masakin-dhabbat",
    nameAr: "مساكن الضباط",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.0482374, 31.3909549),
    mapQuery: "30.0482374,31.3909549",
    lat: 30.0482374,
    lng: 31.3909549,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.0482374, 31.3909549, 18),
  },
  {
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.0569117, 31.4005032),
    mapQuery: "30.0569117,31.4005032",
    lat: 30.0569117,
    lng: 31.4005032,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.0569117, 31.4005032, 18),
  },
  {
    id: "ismailia-14",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.0495768, 31.3882602),
    mapQuery: "30.0495768,31.3882602",
    lat: 30.0495768,
    lng: 31.3882602,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.0495768, 31.3882602, 18),
  },
  {
    id: "ismailia-13",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.0501768, 31.3888602),
    mapQuery: "30.0501768,31.3888602",
    lat: 30.0501768,
    lng: 31.3888602,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.0501768, 31.3888602, 18),
  },
