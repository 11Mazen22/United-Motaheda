...
export const locations = [
  {
    ...
    mapsDirectionsUrl: buildBranchDirectionsUrl(29.974689, 31.277849),
    mapQuery: "29.974689,31.277849",
    lat: 29.974689,
    lng: 31.277849,
    mapZoom: 18,
    isPrimary: true,
    ...
    mapEmbedSrc: buildMapEmbedUrl(29.974689, 31.277849, 18),
  },
  {
    id: "maadi",
    nameAr: "المعادي",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.005823, 31.228783),
    mapQuery: "30.005823,31.228783",
    lat: 30.005823,
    lng: 31.228783,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "المعادي",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.005823, 31.228783, 18),
  },
  {
    id: "masakin-dhabbat",
    nameAr: "مساكن الضباط",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.081112, 31.345743),
    mapQuery: "30.081112,31.345743",
    lat: 30.081112,
    lng: 31.345743,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.081112, 31.345743, 18),
  },
  {
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.073556, 31.354220),
    mapQuery: "30.073556,31.354220",
    lat: 30.073556,
    lng: 31.354220,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.073556, 31.354220, 18),
  },
  {
    id: "ismailia-14",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.063412, 31.356925),
    mapQuery: "30.063412,31.356925",
    lat: 30.063412,
    lng: 31.356925,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.063412, 31.356925, 18),
  },
  {
    id: "ismailia-13",
    ...
    hoursAr: sharedBranchHoursAr,
    hoursEn: sharedBranchHoursEn,
    mapsDirectionsUrl: buildBranchDirectionsUrl(30.052940, 31.395260),
    mapQuery: "30.052940,31.395260",
    lat: 30.052940,
    lng: 31.395260,
    mapZoom: 18,
    isPrimary: false,
    ...
    area: "مدينة نصر",
    deliveryEnabled: true,
    mapEmbedSrc: buildMapEmbedUrl(30.052940, 31.395260, 18),
  },
