...
export const kit = {
  ...
  color: {
    ...
    pressedTint: "rgba(14, 126, 116, 0.08)", selectedBg: "#E6F4F2", focusRing: "#0E7E74",
  },
  darkColor: {
    accent: '#2CCBBD',
    accentDeep: '#0E9B8E',
    ...
    well: '#172033',
    line: '#334155',
    lineStrong: 'rgba(248,250,252,0.12)',
    success: '#4ADE80',
    successTint: '#14532D',
    warn: '#FBBF24',
    warnTint: '#4A3510',
    ...
    neutralHover: 'rgba(248,250,252,0.06)',
    neutralOverlay: 'rgba(0,0,0,0.60)',
    white: '#ffffff',
    black: '#000000',
    pressedTint: 'rgba(44, 203, 189, 0.08)',
    selectedBg: '#123E3A',
    focusRing: '#2CCBBD',
  },
  ...
  type: { 
    display: { fontSize: 26, lineHeight: 32 }, title: { fontSize: 20, lineHeight: 26 }, heading: { fontSize: 17, lineHeight: 24 }, body: { fontSize: 14, lineHeight: 20 }, caption: { fontSize: 12, lineHeight: 17 }, micro: { fontSize: 10, lineHeight: 14 },
    price: { fontSize: 18, lineHeight: 24 },
    priceLg: { fontSize: 22, lineHeight: 28 },
    priceStruck: { fontSize: 14, lineHeight: 20 },
    btnLabel: { fontSize: 15, lineHeight: 20 },
    navLabel: { fontSize: 11, lineHeight: 16 },
    badge: { fontSize: 11, lineHeight: 14 },
    eyebrow: { fontSize: 11, lineHeight: 16 },
    sectionHead: { fontSize: 18, lineHeight: 24 },
  },
